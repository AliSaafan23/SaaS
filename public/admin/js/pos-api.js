const PosApi = {
    ...
    async request(path, options = {}) {
        ...
        try {
            ...
            data = { success: false, message: this.t('common.responseError', 'Response error') };
        }
    ...
    _openDialog({ mode, title, message, confirmText, cancelText, variant, type }) {
        ...
        if (cancelBtn) cancelBtn.textContent = cancelText || this.t('dialog.cancel');
    ...
    initTheme() {
        ...
        if (document.readyState === 'loading') {
            document.addEventListener('DOMContentLoaded', () => this.updateThemeIcon(theme));
        } else {
