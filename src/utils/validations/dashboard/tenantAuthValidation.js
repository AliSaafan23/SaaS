...
const tenantAuthValidation = {
    validateRegister() {
        return withMiddleware([
            ...
            body('adminName')
                .notEmpty()
                .withMessage(() => errorRes.responseError('fail', i18n.__('adminNameRequired'))),
            body('email')
                .notEmpty()
            ...
            body('password')
                ...
                .isLength({ min: 8 })
                .withMessage(() => errorRes.responseError('fail', i18n.__('passwordTooShort'))),
        ]);
    },
    ...
    validateVerifyEmail() {
        return withMiddleware([
            ...
            body('code')
                .notEmpty()
                .withMessage(() => errorRes.responseError('fail', i18n.__('activationCodeRequired')))
                .isLength({ min: 6, max: 6 })
                .withMessage(() => errorRes.responseError('fail', i18n.__('invalidActivationCode'))),
        ]);
    },
