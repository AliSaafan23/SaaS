...
router.get("/", requirePermission(TENANT_PERMISSIONS.CUSTOMERS_READ), asyncHandler(customerController.list));
router.get(
  "/:id",
  requirePermission(TENANT_PERMISSIONS.CUSTOMERS_READ),
